...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/pcie3_ttk_rcd_tb/simulation/submodules/pcie3_ttk_rcd_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv \
  $QSYS_SIMDIR/pcie3_ttk_rcd_tb/simulation/submodules/pcie3_ttk_rcd_mm_interconnect_0_avalon_st_adapter.v \
  ...
  $QSYS_SIMDIR/pcie3_ttk_rcd_tb/simulation/submodules/altera_std_synchronizer_nocut.v \
  ...
  $QSYS_SIMDIR/pcie3_ttk_rcd_tb/simulation/submodules/alt_xcvr_reconfig_cpu_mm_interconnect_0_avalon_st_adapter.v \
  $QSYS_SIMDIR/pcie3_ttk_rcd_tb/simulation/submodules/alt_xcvr_reconfig_cpu_mm_interconnect_0_avalon_st_adapter_er.sv \
  ...
  $QSYS_SIMDIR/pcie3_ttk_rcd_tb/simulation/submodules/altpcie_scfifo.v \
  $QSYS_SIMDIR/pcie3_ttk_rcd_tb/simulation/submodules/altpcie_sv_scfifo_ext.v \
  $QSYS_SIMDIR/pcie3_ttk_rcd_tb/simulation/submodules/altpcie_scfifo_sv.v \
  $QSYS_SIMDIR/pcie3_ttk_rcd_tb/simulation/submodules/altpcie_sv_gbfifo.v \
  $QSYS_SIMDIR/pcie3_ttk_rcd_tb/simulation/submodules/altpcie_tlp_inspector.v \
  $QSYS_SIMDIR/pcie3_ttk_rcd_tb/simulation/submodules/altpcie_tlp_inspector_trigger.v \
  $QSYS_SIMDIR/pcie3_ttk_rcd_tb/simulation/submodules/altpcie_hip_eq_dprio.v \
  $QSYS_SIMDIR/pcie3_ttk_rcd_tb/simulation/submodules/altpcie_hip_eq_bypass_ph3.v \
  $QSYS_SIMDIR/pcie3_ttk_rcd_tb/simulation/submodules/altpcietb_bfm_pipe_8to32.v \
  $QSYS_SIMDIR/pcie3_ttk_rcd_tb/simulation/submodules/altpcie_inspector.sv \
  $QSYS_SIMDIR/pcie3_ttk_rcd_tb/simulation/submodules/altpcie_monitor_sv_dlhip_sim.sv \
  $QSYS_SIMDIR/pcie3_ttk_rcd_tb/simulation/submodules/altpcie_tlp_inspector_monitor.sv \
  $QSYS_SIMDIR/pcie3_ttk_rcd_tb/simulation/submodules/altpcie_tlp_inspector_cseb.sv \
