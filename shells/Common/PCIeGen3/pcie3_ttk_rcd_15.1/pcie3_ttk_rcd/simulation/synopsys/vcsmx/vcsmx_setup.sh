...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/pcie3_ttk_rcd_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv"         -work error_adapter_0                             
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/pcie3_ttk_rcd_mm_interconnect_0_avalon_st_adapter.v"                          -work avalon_st_adapter                           
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                  -work rsp_mux                                     
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/pcie3_ttk_rcd_mm_interconnect_0_rsp_mux.sv"                                   -work rsp_mux                                     
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/pcie3_ttk_rcd_mm_interconnect_0_rsp_demux.sv"                                 -work rsp_demux                                   
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                                  -work cmd_mux                                     
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/pcie3_ttk_rcd_mm_interconnect_0_cmd_mux.sv"                                   -work cmd_mux                                     
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/pcie3_ttk_rcd_mm_interconnect_0_cmd_demux.sv"                                 -work cmd_demux                                   
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/pcie3_ttk_rcd_mm_interconnect_0_router_002.sv"                                -work router_002                                  
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/pcie3_ttk_rcd_mm_interconnect_0_router.sv"                                    -work router                                      
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                                                 -work alt_xcvr_reconfig_0_reconfig_mgmt_agent     
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                                          -work alt_xcvr_reconfig_0_reconfig_mgmt_agent     
  ...
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                                            -work alt_xcvr_reconfig_0_reconfig_mgmt_translator
  ...
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/pcie3_ttk_rcd_master_0_p2b_adapter.sv"                                        -work p2b_adapter                                 
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/pcie3_ttk_rcd_master_0_b2p_adapter.sv"                                        -work b2p_adapter                                 
  ...
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/pcie3_ttk_rcd_master_0_timing_adt.sv"                                         -work timing_adt                                  
  ...
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/pcie3_ttk_rcd_mm_interconnect_0.v"                                            -work mm_interconnect_0                           
  ...
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/pcie3_ttk_rcd_master_0.v"                                                     -work master_0                                    
  ...
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/alt_xcvr_reconfig_h.sv"                                                       -work DUT                                         
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altpcie_reconfig_driver.sv"                                                   -work DUT                                         
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/pcie3_ttk_rcd.v"                                                                                                                           
fi
