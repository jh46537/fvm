...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/alt_xcvr_reconfig_cpu_mm_interconnect_0_router.sv"        -work alt_xcvr_reconfig_0   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/alt_xcvr_reconfig_cpu_mm_interconnect_0_router_001.sv"    -work alt_xcvr_reconfig_0   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/alt_xcvr_reconfig_cpu_mm_interconnect_0_router_002.sv"    -work alt_xcvr_reconfig_0   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/alt_xcvr_reconfig_cpu_mm_interconnect_0_router_003.sv"    -work alt_xcvr_reconfig_0   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/alt_xcvr_reconfig_cpu_mm_interconnect_0_cmd_demux.sv"     -work alt_xcvr_reconfig_0   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/alt_xcvr_reconfig_cpu_mm_interconnect_0_cmd_demux_001.sv" -work alt_xcvr_reconfig_0   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                              -work alt_xcvr_reconfig_0   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/alt_xcvr_reconfig_cpu_mm_interconnect_0_cmd_mux.sv"       -work alt_xcvr_reconfig_0   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/alt_xcvr_reconfig_cpu_mm_interconnect_0_cmd_mux_001.sv"   -work alt_xcvr_reconfig_0   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/alt_xcvr_reconfig_cpu_mm_interconnect_0_rsp_mux.sv"       -work alt_xcvr_reconfig_0   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/alt_xcvr_reconfig_cpu_mm_interconnect_0_rsp_mux_001.sv"   -work alt_xcvr_reconfig_0   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/alt_xcvr_reconfig_h.sv"                                   -work pcie_reconfig_driver_0
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altpcie_reconfig_driver.sv"                               -work pcie_reconfig_driver_0
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altpcied_sv_hwtcl.sv"                                     -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_hip_rs.v"                                       -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_tl_cfg_sample.v"                                -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_rx_ecrc_128_sim.v"                              -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_rx_ecrc_64_sim.v"                               -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_tx_ecrc_128_sim.v"                              -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_tx_ecrc_64_sim.v"                               -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_ast256_downstream.v"                            -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_cdma_app_icm.v"                                 -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_cdma_ast_msi.v"                                 -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_cdma_ast_rx.v"                                  -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_cdma_ast_rx_128.v"                              -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_cdma_ast_rx_64.v"                               -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_cdma_ast_tx.v"                                  -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_cdma_ast_tx_128.v"                              -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_cdma_ast_tx_64.v"                               -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_cdma_ecrc_check_128.v"                          -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_cdma_ecrc_check_64.v"                           -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_cdma_ecrc_gen.v"                                -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_cdma_ecrc_gen_calc.v"                           -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_cdma_ecrc_gen_ctl_128.v"                        -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_cdma_ecrc_gen_ctl_64.v"                         -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_cdma_ecrc_gen_datapath.v"                       -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_compliance_test.v"                              -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_cpld_rx_buffer.v"                               -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_cplerr_lmi.v"                                   -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_dma_descriptor.v"                               -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_dma_dt.v"                                       -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_dma_prg_reg.v"                                  -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_example_app_chaining.v"                         -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_npcred_monitor.v"                               -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_pcie_reconfig_initiator.v"                      -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_rc_slave.v"                                     -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_read_dma_requester.v"                           -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_read_dma_requester_128.v"                       -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_reconfig_clk_pll.v"                             -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_reg_access.v"                                   -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_rxtx_downstream_intf.v"                         -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_tx_ecrc_ctl_fifo.v"                             -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_tx_ecrc_data_fifo.v"                            -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_tx_ecrc_fifo.v"                                 -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_write_dma_requester.v"                          -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcierd_write_dma_requester_128.v"                      -work APPS                  
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcie_sv_hip_ast_hwtcl.v"                               -work DUT                   
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcie_hip_256_pipen1b.v"                                -work DUT                   
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcie_rs_serdes.v"                                      -work DUT                   
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altpcie_rs_hip.v"                                         -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altpcie_ptk.sv"                                           -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altpcie_monitor_sv_dlhip_sim.sv"                          -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_xcvr_functions.sv"                                 -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_pcs.sv"                                                -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_pcs_ch.sv"                                             -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_pma.sv"                                                -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_reconfig_bundle_to_xcvr.sv"                            -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_reconfig_bundle_to_ip.sv"                              -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_reconfig_bundle_merger.sv"                             -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_rx_pma.sv"                                             -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_tx_pma.sv"                                             -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_tx_pma_ch.sv"                                          -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_xcvr_h.sv"                                             -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_xcvr_avmm_csr.sv"                                      -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_xcvr_avmm_dcd.sv"                                      -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_xcvr_avmm.sv"                                          -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_xcvr_data_adapter.sv"                                  -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_xcvr_native.sv"                                        -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_xcvr_plls.sv"                                          -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/alt_xcvr_resync.sv"                                       -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_hssi_10g_rx_pcs_rbc.sv"                                -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_hssi_10g_tx_pcs_rbc.sv"                                -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_hssi_8g_rx_pcs_rbc.sv"                                 -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_hssi_8g_tx_pcs_rbc.sv"                                 -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_hssi_8g_pcs_aggregate_rbc.sv"                          -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_hssi_common_pcs_pma_interface_rbc.sv"                  -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_hssi_common_pld_pcs_interface_rbc.sv"                  -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_hssi_pipe_gen1_2_rbc.sv"                               -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_hssi_pipe_gen3_rbc.sv"                                 -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_hssi_rx_pcs_pma_interface_rbc.sv"                      -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_hssi_rx_pld_pcs_interface_rbc.sv"                      -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_hssi_tx_pcs_pma_interface_rbc.sv"                      -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_hssi_tx_pld_pcs_interface_rbc.sv"                      -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_xcvr_emsip_adapter.sv"                                 -work DUT                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/sv_xcvr_pipe_native.sv"                                   -work DUT                   
  vlogan +v2k           "$QSYS_SIMDIR/pcie_de_gen3_x8_ast256.v"                                                                        
fi
