...
alias com {
  ...
  vlog  "$QSYS_SIMDIR/submodules/altpcied_sv_hwtcl.sv"                                     -work APPS                  
...
alias elab {
  echo "\[exec\] elab"
  eval vsim +access +r -t ps $ELAB_OPTIONS -L work -L rst_controller -L alt_xcvr_reconfig_0 -L pcie_reconfig_driver_0 -L APPS -L DUT -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L stratixv_ver -L stratixv_hssi_ver -L stratixv_pcie_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L rst_controller -L alt_xcvr_reconfig_0 -L pcie_reconfig_driver_0 -L APPS -L DUT -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L stratixv_ver -L stratixv_hssi_ver -L stratixv_pcie_hip_ver $TOP_LEVEL_NAME
}
