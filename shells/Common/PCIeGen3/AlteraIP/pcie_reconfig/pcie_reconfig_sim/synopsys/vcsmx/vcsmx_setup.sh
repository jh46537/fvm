...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/alt_xcvr_reconfig/alt_xcvr_reconfig_cpu_mm_interconnect_0_addr_router.sv"        -work pcie_reconfig
  vlogan +v2k -sverilog "$QSYS_SIMDIR/alt_xcvr_reconfig/alt_xcvr_reconfig_cpu_mm_interconnect_0_addr_router_001.sv"    -work pcie_reconfig
  vlogan +v2k -sverilog "$QSYS_SIMDIR/alt_xcvr_reconfig/alt_xcvr_reconfig_cpu_mm_interconnect_0_id_router.sv"          -work pcie_reconfig
  vlogan +v2k -sverilog "$QSYS_SIMDIR/alt_xcvr_reconfig/alt_xcvr_reconfig_cpu_mm_interconnect_0_id_router_001.sv"      -work pcie_reconfig
  vlogan +v2k -sverilog "$QSYS_SIMDIR/alt_xcvr_reconfig/alt_xcvr_reconfig_cpu_mm_interconnect_0_cmd_xbar_demux.sv"     -work pcie_reconfig
  vlogan +v2k -sverilog "$QSYS_SIMDIR/alt_xcvr_reconfig/alt_xcvr_reconfig_cpu_mm_interconnect_0_cmd_xbar_demux_001.sv" -work pcie_reconfig
  vlogan +v2k -sverilog "$QSYS_SIMDIR/alt_xcvr_reconfig/altera_merlin_arbitrator.sv"                                   -work pcie_reconfig
  vlogan +v2k -sverilog "$QSYS_SIMDIR/alt_xcvr_reconfig/alt_xcvr_reconfig_cpu_mm_interconnect_0_cmd_xbar_mux.sv"       -work pcie_reconfig
  vlogan +v2k -sverilog "$QSYS_SIMDIR/alt_xcvr_reconfig/alt_xcvr_reconfig_cpu_mm_interconnect_0_cmd_xbar_mux_001.sv"   -work pcie_reconfig
  vlogan +v2k -sverilog "$QSYS_SIMDIR/alt_xcvr_reconfig/alt_xcvr_reconfig_cpu_mm_interconnect_0_rsp_xbar_mux.sv"       -work pcie_reconfig
  vlogan +v2k -sverilog "$QSYS_SIMDIR/alt_xcvr_reconfig/alt_xcvr_reconfig_cpu_mm_interconnect_0_rsp_xbar_mux_001.sv"   -work pcie_reconfig
