...
lappend arg_list "--component-param=MEM_TINIT_CK=512000"
...
lappend arg_list "--component-param=MR0_PD=1"
...
lappend arg_list "--component-param=SEQ_ROM=ddr3_dimm0_example_if0_s0_sequencer_mem.hex"
lappend arg_list "--component-param=RAM_BLOCK_TYPE=AUTO"
lappend arg_list "--component-param=AC_ROM_INIT_FILE_NAME=ddr3_dimm0_example_if0_s0_AC_ROM.hex"
lappend arg_list "--component-param=INST_ROM_INIT_FILE_NAME=ddr3_dimm0_example_if0_s0_inst_ROM.hex"
...
lappend arg_list "--component-param=SEQUENCER_MEM_SIZE=35840"
...
lappend arg_list "--output-name=ddr3_dimm0_example_if0_s0"
lappend arg_list "--system-info=DEVICE_FAMILY=STRATIXV"
lappend arg_list "--report-file=sopcinfo:ddr3_dimm0_example_if0_s0.sopcinfo"
lappend arg_list "--report-file=txt:ddr3_dimm0_example_if0_s0_seq_ipd_report.txt"
lappend arg_list "--file-set=QUARTUS_SYNTH"
catch { eval [concat [list exec "C:/altera/14.0.2.209/quartus/sopc_builder/bin/ip-generate" --component-name=qsys_sequencer_110] $arg_list] } temp
puts $temp
